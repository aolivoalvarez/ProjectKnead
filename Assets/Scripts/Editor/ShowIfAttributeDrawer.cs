/*-----------------------------------------
Creation Date: 3/15/2024 6:47:55 PM
Author: theco
Description: Property drawer for the custom attribute ShowIf.
-----------------------------------------*/
...
public class ShowIfAttributeDrawer : PropertyDrawer
{
    ...
    private static IEnumerable<FieldInfo> GetAllFields(object target, Func<FieldInfo, bool> predicate)
    {
        ...
        {
            IEnumerable<FieldInfo> fieldInfos = types[i].GetFields(BindingFlags.Instance |
                BindingFlags.Static | BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.DeclaredOnly).Where(predicate);
    ...
    private static IEnumerable<MethodInfo> GetAllMethods(object target, Func<MethodInfo, bool> predicate)
    {
        IEnumerable<MethodInfo> methodInfos = target.GetType().GetMethods(BindingFlags.Instance | 
            BindingFlags.Static | BindingFlags.NonPublic | BindingFlags.Public).Where(predicate);
